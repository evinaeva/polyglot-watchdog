...
- **Rules:**
  - Records MUST include URL/page grouping fields.
  - Records MUST NOT include per-element screenshot linkage.
...
- **Rules:**
  - Categories MUST be selected from an enumerated set.
