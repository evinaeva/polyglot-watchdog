...
- persisted issue artifacts and operator-facing issue exploration, with domain and run selection to view historical results, and multi-select filters for state and type
