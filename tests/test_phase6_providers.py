...
def test_llm_provider_malformed_response_degrades_safely():
...
def test_llm_provider_parses_and_clamps_json_response():
    ...
    assert sg.provider_meta["provider_score_summary"] == {"spelling_score": 1.0, "grammar_score": 0.42}

    assert meaning.meaning_mismatch_score == 0.0
    assert meaning.provider_meta["provider_score_summary"] == {"meaning_mismatch_score": 0.0}
