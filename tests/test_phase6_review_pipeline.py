...
def test_llm_mode_missing_key_falls_back_without_changing_category(monkeypatch):
    ...
    assert spelling_issue["evidence"]["provider_meta"]["fallback_origin"] == "deterministic_offline"
    assert spelling_issue["evidence"]["provider_meta"]["fallback_review_mode"] == "test-heuristic"
    assert spelling_issue["evidence"]["provider_meta"]["confidence_provenance"] == "heuristic"
