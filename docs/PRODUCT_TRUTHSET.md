...
- the issues explorer UI supports discovery of historical results across domain aliases, a domain selector to scope results, multi-select filters for issue state, severity, and type, and improved human-readable labels for persisted run artifacts;
